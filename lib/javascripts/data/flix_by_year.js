...
(function() {
  ...
  dTotals.stacks = [
    newStackWrap('cdn', dTotals.cdn, dTotals.shared),
    newStackWrap('usa', dTotals.usa, dTotals.shared2)
  ];
  ...
  function newStackWrap(id, exclusiveVals, sharedVals) {
    var stack = [{id: 'exclusive', values: exclusiveVals}, {id: 'shared', values: sharedVals}]
    return {id: id, values: stack};
  };

  function stackWrap(id, vals) {
    return {id: id, values: vals.slice()};
  };
