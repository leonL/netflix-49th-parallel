  ...
  renderHeader: function() {
    ...
    var usaLegend = legend.append('g').attr('class', 'usa')
                      .attr('transform', UTIL.transformTranslate(
                          {x: cdnWidth + dims.swatchRaidus * 8, y: 0}));
